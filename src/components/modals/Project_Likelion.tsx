  ...
  return (
    <div className='animate-fadeIn'>
      ...
      <div className='text-[16px] mb-2'>
        <div className='m-2'>· 강남대학교 멋쟁이사자처럼 13기 동아리 부원 모집 홈페이지에요.</div>
        <div className='m-2'>· 부원 모집기간 중 300명 이상의 사용자가 접속했고 110명 이상의 유저가 회원가입했어요.</div>
        <div className='m-2'>· 총 68명이 LikeLionKNU 서비스를 통해 지원서를 작성했어요.</div>
      </div>
      <SectionLine />
      <div className='text-[20px] font-bold my-2'>프로젝트 기능 </div>
      <div className='text-[16px] mb-2 ml-2'>· 동아리 소개, 지원서 작성/조회, 서류합격 결과 조회, 면접 공지, 동아리 공지사항 서비스를 제공해요.</div>
      <SectionLine />
      ...
      <div className='text-[16px] font-bold mt-5 ml-2'>Vite (CRA → Vite Migration)</div>
      <div className='ml-2'> · 초기에는 CRA(Create React App, Webpack)로 프로젝트를 시작했지만, Vite로 마이그레이션하여 빌드 속도를 약 3배 이상 개선시켰어요.</div>
      ...
      <div className='text-[16px] font-bold mt-5 ml-2'>개발 프로세스</div>
      <div className='ml-2'>
      ...
      <div className='text-[16px] font-bold mt-5 ml-2'>인증 및 권한 관리</div>
      <div className='ml-2'>
      ...
      <div className='text-[16px] font-bold mt-5 ml-2'>협업 경험과 성장</div>
      <div className='ml-2'>
        기획자, 디자이너, 개발자가 한 팀이 되어 아이디어를 자유롭게 공유하고, 서비스를 함께 만들어가는 과정을 경험하며 즐거움을 느꼈어요. 특히 프론트엔드 개발자로서, 다른 직군의 팀원들과 가장
        가까이에서 소통하며 아이디어를 실제 서비스로 구현하는 연결고리 역할을 할 수 있었어요.
      </div>
    </div>
  )
}
