...
export default function Project_Knock() {
  return (
    <div>
      <div className='text-xl md:text-[24px] font-bold mb-2'>Knock: 부동산 거래 위험도 분석 서비스</div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4'>
        <div className='flex flex-col items-center'>
          <div className='text-base md:text-[18px] font-semibold mb-2'>Web</div>
          <img
        ...
        <div className='flex flex-col items-center'>
          <div className='text-base md:text-[18px] font-semibold mb-2'>Mobile</div>
          <img
      ...
      <div className='text-sm md:text-base ml-1 md:ml-2'>· 서버 상태 관리와 데이터 페칭을 위해 TanStack Query를 사용하여 파일 업로드, AI 분석 요청, 결과 조회 등의 비동기 처리를 효율적으로 관리했어요.</div>
      <div className='text-sm md:text-[16px] font-bold mt-3 md:mt-5 ml-1 md:ml-2'>Python Flask</div>
      ...
      <div className='text-sm md:text-base my-1 md:m-2'>· 표제부, 갑구, 을구 각 섹션별 가중치를 조정하여 실제 부동산 거래에 유용한 위험도 지표를 제공해요.</div>

      <div className='text-sm md:text-[16px] font-bold mt-3 md:mt-5 my-1 md:m-2'>팀 협업 및 역할 분담</div>
      <div className='text-sm md:text-base my-1 md:m-2'>· 프론트엔드 1명(본인), 백엔드 2명, AI 1명으로 구성된 총 4명의 팀에서 개발을 진행했어요.</div>
      <div className='text-sm md:text-base my-1 md:m-2'>· 프론트엔드 파트를 전담하여 파일 업로드, AI 분석 결과 시각화, 사용자 인터페이스까지 전체 프론트엔드 개발을 책임졌어요.</div>

      <div className='text-sm md:text-[16px] font-bold mt-3 md:mt-5 ml-1 md:ml-2'>프론트엔드 개발 경험</div>
      <div className='text-sm md:text-base my-1 md:m-2'>· 토스와 최신 UI/UX 디자인 레퍼런스를 참고하여 직관적이고 모던한 인터페이스를 설계했어요.</div>
      <div className='text-sm md:text-base my-1 md:m-2'>· 일관된 디자인 시스템과 버튼, 색상, 타이포그래피를 통해 사용자 경험을 최대한 편리하도록 고려했어요.</div>
      <div className='text-sm md:text-base my-1 md:m-2'>· 복잡한 등기부등본 분석 과정을 단순하고 직관적인 플로우로 만드는 것이 힘들었지만 매우 재미있는 도전이었어요.</div>
